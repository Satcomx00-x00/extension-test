...
async function processMicrosoftFormQuestion(questionElement) {
    ...
    try {
        ...
        if (!questionTextEl)
            return; // Skip if no question text found
        const questionText = ((_a = questionTextEl.textContent) === null || _a === void 0 ? void 0 : _a.trim()) || '';
...
function microsoftFormsFindBestMatchingOption(options, answer) {
    try {
        ...
        const optionsWithText = options.map(opt => {
            ...
            return {
                element: opt,
                text: labelEl ? ((_a = labelEl.textContent) === null || _a === void 0 ? void 0 : _a.trim().toLowerCase()) || '' : ''
            };
        });
...
function microsoftFormsFindCheckboxOptionsToSelect(options, answer) {
    try {
        const answerLower = answer.toLowerCase();
