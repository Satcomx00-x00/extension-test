...
function googleFormsFindBestMatchingOption(options: Element[], answer: string): Element | null {
  try {
...
function googleFormsFindCheckboxOptionsToSelect(options: Element[], answer: string): Element[] {
  try {
    const answerLower = answer.toLowerCase();
